      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-[#111] border border-white/10 rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm">
          ...
          <div className="px-8 pt-10 pb-6 border-b border-white/10">
            ...
            <p className="text-gray-400 mt-2 text-sm">Mettez à jour les informations ci-dessous.</p>
          </div>

          <form action={updateProduct} className="p-8 space-y-8">
            ...
            <div className="pt-6">
              ...
              >
                ...
                <svg className="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
              </button>
            </div>
